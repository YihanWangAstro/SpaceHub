...
int main(int argc, char **argv) {
    ...
    /*--------------------------------------------------New-----------------------------------------------------------*/
    auto inner_orb1 = orbit::EllipOrbit(p1.mass, p2.mass, 5_AU, 0.001, 1_deg, 2_deg, 3_deg, 4_deg);
    ...
    auto inner_orb2 = orbit::EllipOrbit(p3.mass, p4.mass, 4_AU, 0.1, 10_deg, 2.4_deg, 8.3_deg, 4.8_deg);
    ...
    auto outer_orb =
        orbit::EllipOrbit(orbit::M_tot(p1, p2), orbit::M_tot(p3, p4), 40_AU, 0.1, 6_deg, 7_deg, 8_deg, 9_deg);
