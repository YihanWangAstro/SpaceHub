...
int main(int argc, char **argv) {
    ...
    auto orb = orbit::Elliptic(p1.mass, p2.mass, 5 * unit::AU, 0.0, orbit::isotherm, orbit::isotherm, orbit::isotherm,
                                 orbit::isotherm);

    // you can also fix some angles
    // auto orb = orbit::Elliptic(p1.mass, p2.mass, 5 * unit::AU, 0.0, 0.0_deg, orbit::isotherm,
