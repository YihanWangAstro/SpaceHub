...
int main(int argc, char** argv) {
    ...
    for (size_t i = 0; i < n; ++i) {
        ...
        auto orb1 = orbit::EllipOrbit(star1.mass, p1.mass, 1_AU, 0.0, inclination1, isotherm, isotherm, isotherm);

        auto orb2 = orbit::EllipOrbit(star1.mass, p2.mass, 5_AU, 0.0, inclination1, isotherm, isotherm, isotherm);

        orbit::move_particles(orb1, p1);

        orbit::move_particles(orb2, p2);

        orbit::move_to_COM_frame(star1, p1, p2);
        /*----------------------------------------------------------------------------------------------------------------*/
        // create secondary planetary system

        double inclination2 = acos(random::Uniform(-1.0, 1.0));

        auto orb3 = orbit::EllipOrbit(star2.mass, p3.mass, 1_AU, 0.0, inclination2, isotherm, isotherm, isotherm);

        auto orb4 = orbit::EllipOrbit(star2.mass, p4.mass, 5_AU, 0.0, inclination2, isotherm, isotherm, isotherm);

        orbit::move_particles(orb3, p3);

        orbit::move_particles(orb4, p4);

        orbit::move_to_COM_frame(star2, p3, p4);
        /*----------------------------------------------------------------------------------------------------------------*/
        ...
        orbit::move_to_COM_frame(star1, star2, p1, p2, p3, p4);
        /*----------------------------------------------------------------------------------------------------------------*/
