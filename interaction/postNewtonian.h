...
namespace SpaceH
{
    ...
    private:
        template<bool Swith>
        inline typename std::enable_if<Swith==false>::type
        ...
        template<bool Swith>
        inline typename std::enable_if<Swith==true>::type
        FirstOrder(Vector& acc1, Vector& acc2, const Scalar m1, const Scalar m2,
                   const Vector& p1, const Vector& p2, const Vector& v1, const Vector& v2,
                   const Vector& dr, const Vector& dv)
        {
                    ...
                    const Vector& dr, const Vector& dv)
        {
            ...
            A2 = (-2.0*v1s*v1s + (4.0*v1s - 2.0*v12)*v12 + (1.5*v2s + 4.5*v1s - 6.0*v12 - 1.875*nv1s)*nv1s
            ...
            B2 = -((4.0*v1s - 4.0*v12 - 6.0*nv1s - 15.75*m2*inv_r - 2.0*m1*inv_r)*nv2
                   + (v2s - 5.0*v1s  + 4.0*v12  + 4.5*nv1s + 13.75*m2*inv_r - 2.0*m1*inv_r)*nv1)*C2*m1;
