...
namespace UnitTest {
    ...
    void test_vector_construct() {
        ...
        for (size_t i = 0; i < N; ++i) {
            ...
            T y = SpaceH::Random::Uniform<T>::get(-high, high);
            T z = SpaceH::Random::Uniform<T>::get(-high, high);
        ...
        for (size_t i = 0; i < N; ++i) {
            T s = SpaceH::Random::Uniform<T>::get(-high, high);
            SpaceH::Vec3<T> v(s);
            EXPECT_EQ(s, v.x);
            EXPECT_EQ(s, v.y);
            EXPECT_EQ(s, v.z);
    ...
    void test_vector_add() {
        ...
        for (size_t i = 0; i < N; ++i) {
            T x1 = SpaceH::Random::Uniform<T>::get(-high, high);
            T y1 = SpaceH::Random::Uniform<T>::get(-high, high);
            T z1 = SpaceH::Random::Uniform<T>::get(-high, high);
            T x2 = SpaceH::Random::Uniform<T>::get(-high, high);
            T y2 = SpaceH::Random::Uniform<T>::get(-high, high);
            T z2 = SpaceH::Random::Uniform<T>::get(-high, high);
