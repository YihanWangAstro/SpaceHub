...
std::string files[]={"circular","elliptic","solar_earth","Kozai"};
...
int main(int argc, char**argv)
{
    ...
    
    {
        ...
        arg.path = files[0] + ".init";
        arg.name = prefix + "S" + files[0];
        SpaceH::SimpleRun<f,void,void,void,SpaceH::Basic>(arg);
        
        arg.path = files[1] + ".init";
        arg.name = prefix + "S" + files[1];
        SpaceH::SimpleRun<f,void,void,void,SpaceH::Basic>(arg);
        
        arg.path = files[2] + ".init";
        arg.name = prefix + "S" + files[2];
        SpaceH::SimpleRun<f,void,void,void,SpaceH::Basic>(arg);
        
        arg.endTime = 20*Unit::YEAR;
        arg.path = files[3] + ".init";
        arg.name = prefix + "S" + files[3];
        SpaceH::SimpleRun<f,void,void,void,SpaceH::Basic>(arg);
    }
    ...
    
    {
        ...
        arg.path = files[0] + ".init";
        arg.name = prefix + "S" + files[0];
        SpaceH::performance<f,void,void,void,SpaceH::Basic>(arg);
