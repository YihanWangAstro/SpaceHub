...
namespace space::particle_system {
    ...
    template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions, ReguType RegType>
    template <CONCEPT_PARTICLE_CONTAINER STL>
    ARchainSystem<Particles, Interactions, RegType>::ARchainSystem(Scalar
    time,
    ...
    chain_pos_(particle_set
    .

    size()

    ),
    chain_vel_(particle_set
    .

    size()

    ),
    chain_acc_(particle_set
    .
    ...
    new_index_(particle_set
    .

    size()

    ) {
    Chain::calc_chain_index(this->

    pos(), index_

    );
    Chain::calc_chain(this->
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions, ReguType RegType>
void ARchainSystem<Particles, Interactions, RegType>::advance_time(Scalar
step_size) {
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions, ReguType RegType>
template <typename GenVectorArray>
void ARchainSystem<Particles, Interactions, RegType>::advance_pos(Scalar
step_size,
GenVectorArray const &velocity
) {
Scalar phy_time = regu_.eval_pos_phy_time(*this, step_size);
Chain::calc_chain(velocity, chain_acc_, index()
);  // borrow chain_acc_ as chain velocity buffer.
chain_advance(this->

pos(), chain_pos(), chain_acc_, phy_time
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions, ReguType RegType>
template <typename GenVectorArray>
void ARchainSystem<Particles, Interactions, RegType>::advance_vel(Scalar
step_size,
...
vel(), chain_vel(), chain_acc_, half_time
...
vel(), chain_vel(), chain_acc_, phy_time
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions, ReguType RegType>
void ARchainSystem<Particles, Interactions, RegType>::drift(Scalar
step_size) {
Scalar phy_time = regu_.eval_pos_phy_time(*this, step_size);
chain_advance(this->

pos(), chain_pos(), chain_vel(), phy_time
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions, ReguType RegType>
void ARchainSystem<Particles, Interactions, RegType>::kick(Scalar
step_size) {
Scalar phy_time = regu_.eval_vel_phy_time(*this, step_size);
Scalar half_time = 0.5 * phy_time;
...
Chain::calc_chain(accels_
.

tot_vel_indep_acc(), chain_acc_, index()
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions, ReguType RegType>
void ARchainSystem<Particles, Interactions, RegType>::kick_pseu_vel(Scalar
phy_time) {
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions, ReguType RegType>
void ARchainSystem<Particles, Interactions, RegType>::kick_real_vel(Scalar
phy_time) {
std::swap(aux_vel_,
this->
