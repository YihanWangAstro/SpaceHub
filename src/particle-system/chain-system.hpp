...
namespace space::particle_system {
    ...
    template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions>
    template <CONCEPT_PARTICLE_CONTAINER STL>
    ChainSystem<Particles, Interactions>::ChainSystem(Scalar
    time,
    ...
    pos(), chain_pos(), index_

    );
    Chain::calc_chain(this->

    vel(), chain_vel(), index_
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions>
void ChainSystem<Particles, Interactions>::advance_time(Scalar
dt) {
this->
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions>
template <typename GenVectorArray>
void ChainSystem<Particles, Interactions>::advance_pos(Scalar
step_size,
GenVectorArray const &velocity
) {
Chain::calc_chain(velocity, chain_acc_, index()
);  // borrow chain_acc_ as chain vel increment
chain_advance(this->

pos(), chain_pos(), chain_acc_, step_size
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions>
template <typename GenVectorArray>
void ChainSystem<Particles, Interactions>::advance_vel(Scalar
step_size,
...
vel(), chain_vel(), chain_acc_, step_size
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions>
void ChainSystem<Particles, Interactions>::drift(Scalar
step_size) {
this->
...
pos(), chain_pos(), chain_vel(), step_size

);
}

template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions>
void ChainSystem<Particles, Interactions>::kick(Scalar
step_size) {
if constexpr (Interactions::ext_vel_dep) {
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions>
void ChainSystem<Particles, Interactions>::kick_pseu_vel(Scalar
step_size) {
...
template <CONCEPT_PARTICLES Particles, CONCEPT_INTERACTION Interactions>
void ChainSystem<Particles, Interactions>::kick_real_vel(Scalar
step_size) {
std::swap(aux_vel_,
this->
