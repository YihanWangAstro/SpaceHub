...
\*---------------------------------------------------------------------------*/
  ...
  template<typename U>
  auto BurlishStoer<Real, ErrChecker, StepControl>::impl_iterate(U &particles, typename U::Scalar macro_step_size) -> Scalar  {
  ...
  template<typename U>
  void
  BurlishStoer<Real, ErrChecker, StepControl>::integrate_by_n_steps(U &particles, Scalar macro_step_size, size_t steps) {
