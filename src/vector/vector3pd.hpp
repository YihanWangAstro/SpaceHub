 ...
 * Header file.
 */
#ifndef SPACEHUB_VECTOR3PD_HPP
#define SPACEHUB_VECTOR3PD_HPP
...
struct Vec3<precise_d> {
 public:
  ...
  friend Vec3 operator+(const precise_d c, const Vec3& v) { return Vec3(_mm512_add_pd(_mm512_set1_pd(c), v.mmvalue)); }
  friend Vec3 operator-(const precise_d c, const Vec3& v) { return Vec3(_mm512_sub_pd(_mm512_set1_pd(c), v.mmvalue)); }
  friend Vec3 operator*(const precise_d c, const Vec3& v) { return Vec3(_mm512_mul_pd(_mm512_set1_pd(c), v.mmvalue)); }
  friend Vec3 operator/(const precise_d c, const Vec3& v) { return Vec3(_mm512_div_pd(_mm512_set1_pd(c), v.mmvalue)); }
