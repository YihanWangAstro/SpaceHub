    ...
    ->Slice_Expr<typename TYPE_OF_SELF, UNIQ(Begin), UNIQ(End), UNIQ(Stride), TYPE_OF_SELF::size()>{                   \
        ...
        public:
            ...
            constexpr static size_t size() {
                return constexpr_slice_len(Begin, End, Stride, SrcSize);
            }
            ...
            inline value_type const &eval(size_t i) const {
            ...
            inline value_type &operator[](size_t i) {
                return const_cast<value_type &>(eval(i));
            };
            ...
            Slice_Expr &operator=(const Expr<U> &rhs_expr) {
                ...
                multi_threads_loop(size(), MAX_THREAD_NUM, [&](size_t begin, size_t end){
