...
namespace space::integrator {
    ...
    class Radau {
       ...
       private:
        ...
        static constexpr double g2b_[28] = {
                1.0000000000000000000000000000000, -0.0562625605369221464656521910318,
                1.0000000000000000000000000000000,
                0.0101408028300636299864818047860, -0.236503252273814511453232133812, 1.0000000000000000000000000000000,
                -0.00357589772925161759493445889941, 0.0935376952594620658957484611455,
                -0.589127969386984148827139903460,
                1.0000000000000000000000000000000, 0.00195656540994722107690056706032,
                ...
                -0.00143653023637089154244595529986, 0.0421585277212687077072973470356,
                ...
                0.00127179030902686774929431161484, -0.0387603579159067703699046248206,
    ...
    void GaussRadau<TypeSystem>::predict_new_b(Scalar step_ratio) {
        ...
        for (size_t i = 0; i < final_point; ++i) {
            ...
            calc::array_scale(old_b_[i], b_[6], Q[i] * Radau::est_b(6, i));
            for (size_t j = 6; j > i; --j) {
                calc::array_advance(old_b_[i], b_[j - 1], Q[i] * Radau::est_b(j - 1, i));
            }
