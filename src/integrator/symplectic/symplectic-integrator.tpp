...
namespace SpaceH::integrator {
    ...
    public:
        template<typename T>
        void impl_integrate(ParticleSystem<T> &particles, typename T::Scalar stepLength) {
    ...
    class symplectic4th : public SymIntegrator<symplectic4th, 4> {
    public:
        template<typename T>
        void impl_integrate(ParticleSystem<T> &particles, typename T::Scalar stepLength) {
    ...
    class symplectic6th : public SymIntegrator<symplectic6th, 6> {
    public:
        template<typename T>
        void impl_integrate(ParticleSystem<T> &particles, typename T::Scalar stepLength) {
    ...
    class symplectic8th : public SymIntegrator<symplectic8th, 8> {
    public:
        template<typename T>
        void impl_integrate(ParticleSystem<T> &particles, typename T::Scalar stepLength) {
            /*unroll loop manually*/
    ...
    class symplectic10th : public SymIntegrator<symplectic10th, 10> {
    public:
        template<typename T>
        void impl_integrate(ParticleSystem<T> &particles, typename T::Scalar stepLength) {
            /*unroll loop manually*/
